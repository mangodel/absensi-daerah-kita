...
import { LayoutDashboard, Users, CalendarCheck, CalendarDays, Bell, FileBarChart, Settings, FolderOpen, LogOut } from "lucide-react";
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-card border-t border-border z-50 px-1 py-1 safe-area-pb">
        <div className="flex justify-around overflow-x-auto">
          ...
          <button
            ...
            className="flex flex-col items-center gap-0.5 px-2 py-1.5 rounded-lg text-[9px] font-medium transition-colors text-destructive shrink-0"
          >
